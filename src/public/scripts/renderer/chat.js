...
const modalClose = document.getElementById("file-preview-close");
...
function openReportDialog() {
    ...
    const cancelBtn = document.getElementById("report-close");
    dialog.classList.remove("hidden");
...
form.addEventListener("submit", async (e) => {
    ...
    const hostChoice = (hostSelect && hostSelect.value) ||
...
document.addEventListener("click", (e) => {
    if (e.target.classList.contains("file-preview-btn")) {
        ...
        document.getElementById("file-preview-title").textContent = file.name;
        document.getElementById("file-preview-content").textContent = file.content;
...
function renderImageAsset(dataUrl) {
    const chatBox = document.getElementById("chat-box");
    if (!chatBox)
        return;
    const botContainer = document.createElement("div");
