...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRwaXhlaGhkYnR6c2Jja2Zla3RkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjExNDI0MjcsImV4cCI6MjA3NjcxODQyN30.nR1KCSRQj1E_evQWnE2VaZzg7PgLp2kqt4eDKP2PkpE"; // gitleaks:allow
...
export default function register() {
    ...
    ipcMain.handle("auth:setUsername", async (_event, userId, username) => {
        if (!userId || !username)
    ...
    ipcMain.handle("auth:resetPassword", async (_event, email) => {
        if (!email)
    ...
    ipcMain.handle("sync:saveAllSessions", async (_event, allSessions) => {
